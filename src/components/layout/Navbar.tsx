        ...
        <div className="flex items-center gap-3">
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="inline-flex items-center justify-center h-11 w-11 text-brand-gold/80 border border-brand-gold/30 rounded-full hover:bg-brand-gold hover:text-brand-dark transition-all duration-300"
